...
########################################
host = "postgredwh.postgres.database.azure.com"
user = "postgrsqldwh"
password = "iam12345678#"
...
cursor = conn.cursor()
cursor.execute('DROP DATABASE IF EXISTS postgredwh')
cursor.execute("CREATE DATABASE postgredwh")
